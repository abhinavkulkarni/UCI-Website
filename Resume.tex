...
\begin{parcolumns}[nofirstindent, colwidths={1=.15\linewidth}]{2}
  ...
  Spring '12: Statistical Computing, Graphical Models, Computer Architecture
  }
\end{parcolumns}
\vspace{0.8\baselineskip}
...
\begin{parcolumns}[nofirstindent, colwidths={1=.15\linewidth}]{2}
  ...
  Analysis of open-source Java projects for identification of software aspects and concerns as latent topics using topic modelling (LDA) to quantify scattering of topics across a project and their tangling. Overall effort was a part of comparative study of Object and Aspect Oriented Programming paradigm.\\*
  \\*
...
\begin{parcolumns}[nofirstindent, colwidths={1=.15\linewidth}]{2}
  ...
  \colchunk[2]{%
  \textbf{Master's Thesis:} Focus on Probabilistic Graphical Models \hfill April 2012 - Current\\*
  \\*
...
\begin{parcolumns}[nofirstindent, colwidths={1=.15\linewidth}]{2}
  ...
  \colchunk[2]{%
  \textbf{Languages: }C, C++, Java (Intermediate)\\
  \textbf{Packages/Tools: }R, Eclipse, Visual Studio, MATLAB, Octave
  }
\end{parcolumns}
\vspace{0.8\baselineskip}
